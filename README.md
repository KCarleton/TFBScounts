...
"MatrixID", "Name", "Score", "Relative_score", "SequenceID", "Start", "End", "Strand", and "PredictedSequence". 

The function File_TFnames is used to convert the Name column, which contains the MatrixID.TFname to just TFname and makes it all capitals.
